...
define([
    ...
    "pagination",
    "remodal"
], function ($, utils, config, channelAPI) {
    ...
    var page = {
        ...
        fnGetList: function (data, initPage) {
            ...
            channelAPI.getChannel(data, function (result) {
                ...
                $.each(result.list, function (i, v) {
                    ...
                    pcTd = "<td>" + v.province+v.city + '</td>'
                    var companyTd = '<td>' + (v.company?v.company:'') + '</td>';
                    var nicknameTd = '<td>' + v.nickname  + '</td>';
                    var channelTd = '<td>' + v.channel  + '</td>';



                    oTr += '<tr class="fadeIn animated" data-id="' + v.id + '">' + checkTd + id + pcTd  +   companyTd + nicknameTd+ channelTd + '</tr>';
                });
