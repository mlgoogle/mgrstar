...
<div class="wrap">
    <div class="header">
        <div class="clearfix layout">
            ...
            <div>
            <span class="spantext" >管理员：<?php  $user = session('user'); echo $user['uname'];?>,<a style="color:#FF0000;" href="/work/star/mgrstar/index.php/Home/login/doLoginout" onclick="return confirm('确定退出本系统?')" >系统退出</a></span>
...
<ul class="thumbnails">
    <li class="span4">
        <a href="/work/star/mgrstar/index.php/Home/Star/carousel" class="thumbnail">
            明星管理
        </a>
    </li>
    <li class="span4">
        <a href="/work/star/mgrstar/index.php/Home/Customer/customer" class="thumbnail">
            消费者管理
        </a>
    </li>
    <li class="span4">
        <a href="/work/star/mgrstar/index.php/Home/DataSearch/fundList" class="thumbnail">
            数据查询
        </a>
    </li>
    <li class="span4">
        <a href="/work/star/mgrstar/index.php/Home/accountmanage/userManage" class="thumbnail">
            系统账户管理
        </a>
    </li>
