...
<!--</ul>-->
        ...
        <div class="remodal-body">
            <form class="modalForm">
                <div class="form-control">
                    <label>所属机构</label>
                    <select name="org" class="org_select"></select>
                </div>
                <div class="form-control">
                    <label>区域经纪人</label>
                    <select name="agent" >
    ...
    <div data-remodal-id="checkBrokerModal" class="remodal checkBrokerModal">
        <div class="remodal-head">
            <div class="remodal-title">修改经纪人</div>
            <div data-remodal-action="cancel" class="remodal-close"></div>
        </div>
        <div class="remodal-body">
            <form class="modalForm">
        ...
        <div class="remodal-footer">
            <a href="javascript:;"  class="remodal-confirm J_check">修改</a>
        </div>
    </div>
</div>
