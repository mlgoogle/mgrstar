...
<div class="wrap">
    <div class="header">
        <div class="clearfix layout">
            ...
            <div>
                <span class="spantext" >管理员：<?php echo ($user['uid']); ?>,<a style="color:#FF0000;" href="/xh/index.php/Home/login/doLoginout" onclick="return confirm('确定退出本系统?')" >系统退出</a></span>
            </div>
        </div>
    </div>
    <div class="main">
...
<div class="sidebar">
    <ul class="nav-list">
        ...
        <li class="pli">
            <a href="javascript:;" <?php if(CONTROLLER_NAME == 'DataSearch'){echo 'class="active"';} ?>><i class="icon-align-right"></i><strong> 数据查询</strong></a>
            <ul class="submenu">
                <li><a href="#">资金查询</a></li>
        ...
        <li class="pli">
            <a href="javascript:;" <?php if(CONTROLLER_NAME == 'SystemAccount'){echo 'class="active"';} ?>><i class="icon-user"></i><strong> 系统账户管理</strong></a>
            <ul class="submenu">
                <li><a href="#">账户权限</a></li>
                <li><a href="#">账户角色</a></li>
